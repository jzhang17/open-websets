...
[![React Column Definitions thumbnail](https://img.youtube.com/vi/aDCepyF_DUY/0.jpg)](https://www.youtube.com/watch?v=aDCepyF_DUY)
...
See [Column Options](/react-data-grid/column-properties/) for all available properties.
...
The [Grid Api](/react-data-grid/grid-api/#reference-state-applyColumnState) function `applyColumnState` can be used to update [Column State](/react-data-grid/column-state/).
...
To update an attribute by [Updating Column Definitions](/react-data-grid/column-updating-definitions/#changing-column-definition), pass a new array of [Column Definitions](/react-data-grid/column-definitions/) to the grid options.
...
* [Column Definitions](#top)
* [Column Defaults](#default-column-definitions)
* [Column Types](#column-types)
* [Provided Column Types](#provided-column-types)
* [Updating Columns](#updating-columns)
* [Using Column State](#using-column-state)
* [Updating Column Definitions](#updating-column-definitions)
