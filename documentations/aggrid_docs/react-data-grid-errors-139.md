...
# React Data GridAG Grid React Error #139
...
```
a custom chart theme with the name undefined has been supplied but not added to the 'chartThemes' list
```
