...
# React Data GridAG Grid React Error #177
...
```
valid values for cellSelection.handle.direction are 'x', 'y' and 'xy'. Default to 'xy'.
```
...
* [Fill Handle Axis](/react-data-grid/cell-selection-fill-handle/#fill-handle-axis)

* [AG Grid React Error #177](#top)
