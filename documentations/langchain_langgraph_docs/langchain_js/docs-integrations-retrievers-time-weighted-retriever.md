...
* Retriever [how-to guides](/docs/how%5Fto/#retrievers)
...
[PreviousTavily Search API](/docs/integrations/retrievers/tavily)[NextVespa Retriever](/docs/integrations/retrievers/vespa-retriever)
