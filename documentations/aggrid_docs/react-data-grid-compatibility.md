...
(\*) Note that for versions 32.2.0 - 32.3.1, React 19 is supported, but not listed as a peer dependency.

## Typescript Compatibility [Copy Link](#typescript-compatibility)
...
## Documentation Archive [Copy Link](#documentation-archive)

To view AG Grid documentation for older versions, please refer to the [Documentation archive](/documentation-archive/).

* [Version Compatibility](#top)
* [AG Grid & React Compatibility Chart](#ag-grid--react-compatibility-chart)
