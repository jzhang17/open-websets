...
# React Data GridAG Grid React Error #95
...
```
Either set 'undefined' to an array that includes undefined or to 'false' to disable the page size selector.
```
