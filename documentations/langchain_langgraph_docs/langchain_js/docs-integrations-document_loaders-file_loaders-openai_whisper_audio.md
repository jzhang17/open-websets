...
* OpenAIWhisperAudio from `@langchain/community/document_loaders/fs/openai_whisper_audio`
...
[PreviousNotion markdown export](/docs/integrations/document%5Floaders/file%5Floaders/notion%5Fmarkdown)[NextPDFLoader](/docs/integrations/document%5Floaders/file%5Floaders/pdf)
