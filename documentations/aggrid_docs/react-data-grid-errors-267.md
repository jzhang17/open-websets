...
# React Data GridAG Grid React Error #267
...
```
Detail grids can not use a different theme to the master grid, the `theme` detail grid option will be ignored.
```

To show this error text in the dev console, import the `ValidationModule`.

* [AG Grid React Error #267](#top)
