...
# React Data GridAG Grid React Error #140
...
```
no stock theme exists with the name 'undefined' and no custom chart theme with that name was supplied to 'customChartThemes'
```
...
* [Chart Customisation](/react-data-grid/integrated-charts-customisation/)

* [AG Grid React Error #140](#top)
