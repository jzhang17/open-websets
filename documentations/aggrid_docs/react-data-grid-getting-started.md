...
AG Grid is a high-performance React Data Grid library for building [React Tables](/react-table/) with unbeatable performance and hundreds of features. Available in Community and Enterprise editions. Visit [Community vs. Enterprise](/react-data-grid/community-vs-enterprise/) to learn more.
...
## Create a React Data Grid [Copy Link](#create-a-react-data-grid)

Add AG Grid to your application in 60 seconds:

1

### NPM Install [Copy Link](#npm-install)
...
### Register Modules [Copy Link](#register-modules)
...
To minimize bundle size, only register the modules you want to use. See the [Modules](/react-data-grid/modules/) docs for more information.

3

### Import the React Data Grid [Copy Link](#import-the-react-data-grid)
...
### React Data Grid Component [Copy Link](#react-data-grid-component)
...
### Example React Data Grid [Copy Link](#example-react-data-grid)
...
* [Quick Start](#top)
* [Create a React Data Grid](#create-a-react-data-grid)
* [NPM Install](#npm-install)
* [Register Modules](#register-modules)
* [Import the React Data Grid](#import-the-react-data-grid)
* [Define Rows and Columns](#define-rows-and-columns)
* [React Data Grid Component](#react-data-grid-component)
* [Example React Data Grid](#example-react-data-grid)
