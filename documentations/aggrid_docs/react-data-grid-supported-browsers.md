...
# React Data GridSupported Browsers
...
##  Desktop Browsers [Copy Link](#desktop-browsers) 

The officially supported desktop browsers are as follows:

| Browser                                                     | Supported Version          |
| ----------------------------------------------------------- | -------------------------- |
| ![Chrome](/_astro/chrome.BQiFEGyH.svg) Chrome               | Two latest major versions. |
| ![Firefox](/_astro/firefox._zQPkcuH.svg) Firefox            | Two latest major versions. |
| ![Microsoft Edge](/_astro/edge.mWaXSgsF.svg) Microsoft Edge | Two latest major versions. |
| ![Safari](/_astro/safari.BluC7k17.svg) Safari               | Two latest major versions. |

##  Mobile Browsers [Copy Link](#mobile-browsers) 

The officially supported mobile browsers are as follows:

| Browser                                               | Supported Version                                                                                          |
| ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| ![Safari iOS](/_astro/safari.BluC7k17.svg) Safari iOS | Two latest major versions on iOS devices (iPad / iPhone) only.                                             |
| ![Chrome](/_astro/chrome.BQiFEGyH.svg) Chrome         | Two latest major versions on iOS devices (iPad / iPhone) and Android devices (Android phones and tablets). |
