...
# React Data GridAG Grid React Error #183
...
Group Column Filter only works on group columns. Please use a different filter.
...
* [Row Grouping](/react-data-grid/grouping-display-types/)

* [AG Grid React Error #183](#top)
