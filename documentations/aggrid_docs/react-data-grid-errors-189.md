...
# React Data GridAG Grid React Error #189
...
```
invalid value undefined for startRow, the value should be >= 0
```
...
* [SSRM Datasource](/react-data-grid/server-side-model-datasource/)

* [AG Grid React Error #189](#top)
