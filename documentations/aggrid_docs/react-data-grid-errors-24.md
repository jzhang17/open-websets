...
# React Data GridAG Grid React Error #24
...
row height must be a number if not using standard row model
...
* [Row Height](/react-data-grid/row-height/)

* [AG Grid React Error #24](#top)
