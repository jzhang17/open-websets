...
# React Data GridAG Grid React Error #48
...
```
Cell data type is "object" but no Value undefined has been provided. Please either provide an object data type definition with a Value undefined, or set "colDef.valueundefined"
```
...
* [Cell Data Type](/react-data-grid/cell-data-types/#object)  - Configuration requirements for an 'object' cell data type.

* [AG Grid React Error #48](#top)
