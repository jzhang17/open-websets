...
# React Data GridAG Grid React Error #223
...
agSelectedRowCountComponent should only be used with the client and server side row model.
...
* [Status Bar](/react-data-grid/row-models/)

* [AG Grid React Error #223](#top)
