...
The following [Column Definition](/react-data-grid/column-definitions/) properties set Tooltips:

| tooltipField[Copy Link](#reference-ColDef-tooltipField)ColDefField The field of the tooltip to apply to the cell. @agModule TooltipModule                                                                                                                                                                         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tooltipValueGetter[Copy Link](#reference-ColDef-tooltipValueGetter)Function Callback that should return the string to use for a tooltip, tooltipField takes precedence if set. If using a custom tooltipComponent you may return any custom value to be passed to your tooltip component. @agModule TooltipModule |
| headerTooltip[Copy Link](#reference-ColDef-headerTooltip)string Tooltip for the column header @agModule TooltipModule                                                                                                                                                                                             |

##  Tooltips for Truncated Text [Copy Link](#tooltips-for-truncated-text) 
...
##  Show and Hide Delay [Copy Link](#show-and-hide-delay) 
...
##  Blank Values [Copy Link](#blank-values) 
...
##  Row Groups [Copy Link](#row-groups) 
...
##  Mouse Tracking [Copy Link](#mouse-tracking) 
...
| location[Copy Link](#reference-CustomTooltipProps-location)TooltipLocation What part of the application is showing the tooltip, e.g. 'cell', 'header', 'menuItem' etc |                                       |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| value[Copy Link](#reference-CustomTooltipProps-value)TValue \| null The value to be rendered by the tooltip.                                                          |                                       |
| valueFormatted[Copy Link](#reference-CustomTooltipProps-valueFormatted)string \| null The formatted value to be rendered by the tooltip.                              |                                       |
| colDef[Copy Link](#reference-CustomTooltipProps-colDef)ColDef \| ColGroupDef                                                                                          | null Column / ColumnGroup definition. |
| column[Copy Link](#reference-CustomTooltipProps-column)Column \| ColumnGroup Column / ColumnGroup                                                                     |                                       |
| rowIndex[Copy Link](#reference-CustomTooltipProps-rowIndex)number The index of the row containing the cell rendering the tooltip.                                     |                                       |
| node[Copy Link](#reference-CustomTooltipProps-node)[IRowNode](/react-data-grid/row-object/) The row node.                                                             |                                       |
| data[Copy Link](#reference-CustomTooltipProps-data)TData Data for the row node in question.                                                                           |                                       |
| hideTooltipCallback[Copy Link](#reference-CustomTooltipProps-hideTooltipCallback)Function A callback function that hides the tooltip                                  |                                       |
| api[Copy Link](#reference-CustomTooltipProps-api)[GridApi](/react-data-grid/grid-api/) The grid api.                                                                  |                                       |
| context[Copy Link](#reference-CustomTooltipProps-context)TContext Application context as set on gridOptions.context.                                                  |                                       |

* [Tooltips](#top)
* [Tooltips for Truncated Text](#tooltips-for-truncated-text)
* [Show and Hide Delay](#show-and-hide-delay)
