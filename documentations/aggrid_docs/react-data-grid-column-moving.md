...
##  Moving Animation [Copy Link](#moving-animation) 
...
##  Suppress Hide Leave [Copy Link](#suppress-hide-leave) 
...
##  Suppress Movable [Copy Link](#suppress-movable) 
...
##  Lock Position [Copy Link](#lock-position) 
...
##  Suppress Movable & Lock Position Example [Copy Link](#suppress-movable--lock-position-example) 
...
##  Advanced Locked Position Example [Copy Link](#advanced-locked-position-example) 
...
##  Lock Visible [Copy Link](#lock-visible) 
...
* You can show a column by dragging it from the [Tool Panel](/react-data-grid/tool-panel/) onto the grid (when the grid option `allowDragFromColumnsToolPanel=true`).
...
###  Lock Visible Example [Copy Link](#lock-visible-example) 
...
* [Suppress Hide Leave](#suppress-hide-leave)
* [Suppress Move When Dragging](#suppress-move-when-dragging)
* [Suppress Movable](#suppress-movable)
* [Lock Position](#lock-position)
* [Suppress Movable & Lock Position Example](#suppress-movable--lock-position-example)
* [Advanced Locked Position Example](#advanced-locked-position-example)
* [Lock Visible](#lock-visible)
* [Lock Visible Example](#lock-visible-example)
