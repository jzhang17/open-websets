...
# React Data GridPrinting

![react logo](/_astro/react.CtDRhtxt.svg)React

This section explains how to use the Print Layout feature of the grid.

A grid using print layout will not use any scrollbars so all rows and columns will get printed. The grid will auto-size width and height to fit all contents. This means if the grid is printed on paper all the cells will get included, as opposed to printing a grid with scrollbars and only cells within the visible area will get printed.
...
##  Toggling Print Layout [Copy Link](#toggling-print-layout) 
...
##  Toggling Grid Size [Copy Link](#toggling-grid-size) 
...
##  Page Break [Copy Link](#page-break) 
...
##  Detailed Printing Example [Copy Link](#detailed-printing-example) 
...
##  Animations & Redraw [Copy Link](#animations--redraw) 
...
##  Keep Print Layout for Print Only [Copy Link](#keep-print-layout-for-print-only) 
...
##  Row Models [Copy Link](#row-models) 

The only [Row Model](/react-data-grid/row-models/) that print layout works with is the default [Client Side](/react-data-grid/row-models/#client-side) row model. It will not work with the others ([Infinite](/react-data-grid/infinite-scrolling/), [Server-Side](/react-data-grid/server-side-model/) or [Viewport](/react-data-grid/viewport/)). This is because the grid will render the entire data-set which goes against the philosophy of the other row models which lazy load data.

* [Printing](#top)
* [Toggling Print Layout](#toggling-print-layout)
* [Toggling Grid Size](#toggling-grid-size)
* [Page Break](#page-break)
* [Detailed Printing Example](#detailed-printing-example)
* [Animations & Redraw](#animations--redraw)
* [Don't Print Large Data](#dont-print-large-data)
* [Keep Print Layout for Print Only](#keep-print-layout-for-print-only)
