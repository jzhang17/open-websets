...
#### For `.docx` Files[​](#for-docx-files "Direct link to for-docx-files")
...
#### For `.doc` Files[​](#for-doc-files "Direct link to for-doc-files")
...
### Loading `.docx` Files[​](#loading-docx-files "Direct link to loading-docx-files")
...
### Loading `.doc` Files[​](#loading-doc-files "Direct link to loading-doc-files")
...
[PreviousDirectoryLoader](/docs/integrations/document%5Floaders/file%5Floaders/directory)[NextEPUB files](/docs/integrations/document%5Floaders/file%5Floaders/epub)
