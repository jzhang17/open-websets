...
# React Data GridSelect Cell Editor
...
##  Enabling Select Cell Editor [Copy Link](#enabling-select-cell-editor) 
...
| values[Copy Link](#reference-ISelectCellEditorParams-values)TValue\[\] List of values to display                                                                                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| valueListGap[Copy Link](#reference-ISelectCellEditorParams-valueListGap)numberdefault: 4 The space in pixels between the value display and the list of items.                                                                                                                              |
| valueListMaxHeight[Copy Link](#reference-ISelectCellEditorParams-valueListMaxHeight)number \| string The maximum height of the list of items. If the value is a number it will be treated as pixels, otherwise it should be a valid CSS size string. Default: Height of Popup Parent.      |
| valueListMaxWidth[Copy Link](#reference-ISelectCellEditorParams-valueListMaxWidth)number \| string The maximum width of the list of items. If the value is a number it will be treated as pixels, otherwise it should be a valid CSS size string. Default: Width of the cell being edited. |
...
If you are unhappy with the additional click required, we advise you don't depend on the browsers standard Select (ie avoid `agSelectCellEditor`) and instead use `agRichSelectCellEditor` or create your own using a [Cell Editor Component](/react-data-grid/cell-editors/).

Continue to the next section: [Rich Select Cell Editor](/react-data-grid/provided-cell-editors-rich-select/).

* [Select Cell Editor](#top)
* [Enabling Select Cell Editor](#enabling-select-cell-editor)
