...
These variables use [Variable Cascading](/react-data-grid/theming-v32-customisation-css/#variable-cascading) to allow you to enable/disable all borders quickly or fine tune the borders shown. In the list below, setting a parent item in the list will set the default value for all children:
...
`--ag-cell-horizontal-border` adds a border between cells in the grid area. To add a border between header cells, use [header column separators](/react-data-grid/theming-v32-customisation-headers/#header-column-separators-and-resize-handles).

* [Legacy Themes: Customising Borders](#top)
* [Example: row borders](#example-row-borders)
* [Borders between header cells](#borders-between-header-cells)
