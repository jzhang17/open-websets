...
# React Data GridAG Grid React Error #10
...
```
As of v33, the 'undefined' event is deprecated. Use the global 'modelUpdated' event to determine when row children have changed.
```

To show this error text in the dev console, import the `ValidationModule`.

* [AG Grid React Error #10](#top)
