...
* BrowserbaseLoader from `@langchain/community/document_loaders/web/browserbase`
...
Azure Blob Storage File](/docs/integrations/document_loaders/web_loaders/azure_blob_storage_file)[Next
