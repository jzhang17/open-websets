...
1. Select a [Built-in Theme](/react-data-grid/themes/) as a starting point.
2. Choose a different [Color Scheme](/react-data-grid/theming-colors/#color-schemes) if required.
3. Use [Theme Parameters](/react-data-grid/theming-parameters/) to customise borders, compactness, fonts and more.
4. Use [Theme Parts](/react-data-grid/theming-parts/) to change the appearance of components like the icon set and text inputs.
5. [Write your own CSS](/react-data-grid/theming-css/) for unlimited control over grid appearance.
...
* [Theming](#top)
* [Programmatically changing row and cell appearance](#programmatically-changing-row-and-cell-appearance)
