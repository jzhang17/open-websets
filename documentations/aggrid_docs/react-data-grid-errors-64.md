...
# React Data GridAG Grid React Error #64
...
```
setFilterModel() - unable to fully apply model, unable to create filter for colId: undefined
```
...
* [Filter API](/react-data-grid/filter-api/)

* [AG Grid React Error #64](#top)
