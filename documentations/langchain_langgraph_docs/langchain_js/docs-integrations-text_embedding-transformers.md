...
You'll need to install the [@huggingface/transformers](https://www.npmjs.com/package/%40huggingface/transformers) package as a peer dependency:
...
* HuggingFaceTransformersEmbeddings from `@langchain/community/embeddings/huggingface_transformers`
...
TogetherAI](/docs/integrations/text_embedding/togetherai)[Next
