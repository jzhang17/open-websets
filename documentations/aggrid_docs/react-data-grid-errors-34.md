...
# React Data GridAG Grid React Error #34
...
```
the column type 'undefined' is a default column type and cannot be overridden.
```
...
* [Provided Column Types](/react-data-grid/column-definitions/#provided-column-types)

* [AG Grid React Error #34](#top)
