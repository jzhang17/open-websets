...
2. You will need to get an API key from [Google here](https://developers.google.com/gmail/api/guides)and [enable the new Gmail API](https://console.cloud.google.com/apis/library/gmail.googleapis.com). Then, set the environment variables for `GMAIL_CLIENT_EMAIL`, and either `GMAIL_PRIVATE_KEY`, or `GMAIL_KEYFILE`.
...
* GmailCreateDraft from `@langchain/community/tools/gmail`
* GmailGetMessage from `@langchain/community/tools/gmail`
* GmailGetThread from `@langchain/community/tools/gmail`
* GmailSearch from `@langchain/community/tools/gmail`
* GmailSendMessage from `@langchain/community/tools/gmail`
...
[PreviousExaSearchResults](/docs/integrations/tools/exa%5Fsearch)[NextGOAT](/docs/integrations/tools/goat)
