...
You are currently on a page documenting the use of [text completion models](/docs/concepts/text%5Fllms). Many of the latest and most popular models are [chat completion models](/docs/concepts/chat%5Fmodels).
...
[LLMs](/docs/integrations/llms/docs/concepts/#llms) are language models that takes a string as input and return a string as output.

info

If you'd like to write your own LLM, see [this how-to](/docs/how%5Fto/custom%5Fllm). If you'd like to contribute an integration, see [Contributing integrations](/docs/contributing).

## All LLMs[​](#all-llms "Direct link to All LLMs")

| Name                                                                    | Description                                                              |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [AI21](/docs/integrations/llms/ai21)                                    | You can get started with AI21Labs' Jurassic family of models, as well... |
| [AlephAlpha](/docs/integrations/llms/aleph%5Falpha)                     | LangChain.js supports AlephAlpha's Luminous family of models. You'll ... |
| [Arcjet Redact](/docs/integrations/llms/arcjet)                         | The Arcjet redact integration allows you to redact                       |
| [AWS SageMakerEndpoint](/docs/integrations/llms/aws%5Fsagemaker)        | LangChain.js supports integration with AWS SageMaker-hosted endpoints... |
| [Azure OpenAI](/docs/integrations/llms/azure)                           | \[Azure                                                                  |
| [Bedrock](/docs/integrations/llms/bedrock)                              | Amazon Bedrock is a fully managed                                        |
| [ChromeAI](/docs/integrations/llms/chrome%5Fai)                         | This feature is experimental and is subject to change.                   |
| [Cloudflare Workers AI](/docs/integrations/llms/cloudflare%5Fworkersai) | This will help you get started with Cloudflare Workers AI \[text         |
| [Cohere](/docs/integrations/llms/cohere)                                | This will help you get started with Cohere completion models (LLMs)      |
| [Deep Infra](/docs/integrations/llms/deep%5Finfra)                      | LangChain supports LLMs hosted by Deep Infra through the DeepInfra wr... |
| [Fireworks](/docs/integrations/llms/fireworks)                          | Fireworks AI is an AI inference platform to run                          |
| [Friendli](/docs/integrations/llms/friendli)                            | Friendli enhances AI application performance and optimizes cost savin... |
| [Google Vertex AI](/docs/integrations/llms/google%5Fvertex%5Fai)        | Google Vertex is a service that                                          |
| [Gradient AI](/docs/integrations/llms/gradient%5Fai)                    | LangChain.js supports integration with Gradient AI. Check out Gradien... |
| [HuggingFaceInference](/docs/integrations/llms/huggingface%5Finference) | Here's an example of calling a HugggingFaceInference model as an LLM:    |
| [IBM watsonx.ai](/docs/integrations/llms/ibm)                           | This will help you get started with IBM \[text completion models         |
| [JigsawStack Prompt Engine](/docs/integrations/llms/jigsawstack)        | LangChain.js supports calling JigsawStack Prompt Engine LLMs.            |
| [Layerup Security](/docs/integrations/llms/layerup%5Fsecurity)          | The Layerup Security integration allows you to secure your calls to a... |
| [Llama CPP](/docs/integrations/llms/llama%5Fcpp)                        | Only available on Node.js.                                               |
| [MistralAI](/docs/integrations/llms/mistral)                            | Mistral AI is a platform that offers hosting for                         |
| [Ollama](/docs/integrations/llms/ollama)                                | This will help you get started with Ollama \[text completion models      |
| [OpenAI](/docs/integrations/llms/openai)                                | OpenAI is an artificial                                                  |
| [RaycastAI](/docs/integrations/llms/raycast)                            | Note: This is a community-built integration and is not officially sup... |
| [Replicate](/docs/integrations/llms/replicate)                          | Here's an example of calling a Replicate model as an LLM:                |
| [Together AI](/docs/integrations/llms/together)                         | You are currently on a page documenting the use of Together AI models... |
| [Writer](/docs/integrations/llms/writer)                                | LangChain.js supports calling Writer LLMs.                               |
| [YandexGPT](/docs/integrations/llms/yandex)                             | LangChain.js supports calling YandexGPT LLMs.                            |
...
[PreviousZhipuAI](/docs/integrations/chat/zhipuai)[NextLLMs](/docs/integrations/llms/)
