...
# React Data GridAG Grid React Error #240
...
```
theme grid option must be a Theming API theme object or the string "legacy", received: undefined
```
...
* [Built-in Themes](/react-data-grid/themes/)

* [AG Grid React Error #240](#top)
