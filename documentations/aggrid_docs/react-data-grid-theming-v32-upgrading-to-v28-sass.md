...
# React Data GridUpgrading from the Legacy Sass API
...
If you need to make changes to an app that is still using the legacy API, you can consult the [Archived Documentation for the Legacy API](/react-data-grid/theming-v32-customisation-sass-legacy/).

###  Benefits of the new API [Copy Link](#benefits-of-the-new-api) 
...
##  Upgrade instructions [Copy Link](#upgrade-instructions) 
...
###  Altering your Sass import paths and using the grid-styles mixin [Copy Link](#altering-your-sass-import-paths-and-using-the-grid-styles-mixin) 
...
* [Upgrading from the Legacy Sass API](#top)
* [Benefits of the new API](#benefits-of-the-new-api)
* [Upgrade instructions](#upgrade-instructions)
* [Altering your Sass import paths and using the grid-styles mixin](#altering-your-sass-import-paths-and-using-the-grid-styles-mixin)
