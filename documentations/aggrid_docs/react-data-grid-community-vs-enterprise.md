...
# React Data GridCommunity vs. Enterprise
...
[![Why Choose AG Grid Enterprise for your Data Grid thumbnail](https://img.youtube.com/vi/9t4g5M3CM3o/0.jpg)](https://www.youtube.com/watch?v=9t4g5M3CM3o)
...
### Community Features [Copy Link](#community-features)
...
Custom cell rendering - use your own components inside cells.](/react-data-grid/component-cell-renderer/)[#### Themes and Styling

Pre-built themes and CSS customisation.](/react-data-grid/theming/)[#### Accessibility Support

ARIA support and keyboard navigation.](/react-data-grid/accessibility/)[#### Performance Optimisations

Column and row virtualization enabled by default.](/react-data-grid/dom-virtualisation/)

#### Major Frameworks

Support for React, Angular and Vue, in addition to vanilla JavaScript.

### Enterprise Features [Copy Link](#enterprise-features)

AG Grid Enterprise contains advanced features, which are not available in other data grids, such as:

[#### Server-Side Row Model

Efficiently handle large datasets by loading data on-demand from the server.](/react-data-grid/server-side-model/)[#### Excel Export

Advanced export options, including styles and formulas.](/react-data-grid/excel-export/)[#### Pivot Tables & Aggregations

Built-in pivot and aggregation capabilities for complex data analysis.](/react-data-grid/pivoting/)[#### Range Selection

Select and manipulate ranges of data.](/react-data-grid/cell-selection/)[#### Integrated Charts

Create and customise charts directly within the grid.](/react-data-grid/integrated-charts/)[#### Master/Detail View

Nested grid views for hierarchical data representation.](/react-data-grid/master-detail/)[#### Row Grouping & Multi-Column Sorting

Advanced grouping and sorting options for better data organization.](/react-data-grid/grouping/)[#### Clipboard Operations

Enhanced copy and paste functionality, including support for Excel-like behaviour.](/react-data-grid/clipboard/)[#### Tool Panels

Built-in configuration panels for columns and filters, or create your own custom panels.](/react-data-grid/tool-panel/)[#### Custom Context Menu & Sidebars

Additional UI elements for enhanced user interaction and customisation.](/react-data-grid/context-menu/)

See the [Pricing](/license-pricing/) page for a full feature comparison.

## Enterprise Bundle [Copy Link](#enterprise-bundle)
...
## Test AG Grid Enterprise Features [Copy Link](#test-ag-grid-enterprise-features)
...
## Request an Enterprise Bundle Trial Licence [Copy Link](#request-an-enterprise-bundle-trial-licence)
...
By clicking "Request trial license" you agree to our [Privacy Policy](/privacy/).

## Choosing the Right Version [Copy Link](#choosing-the-right-version)
...
[Install AG Grid Enterprise](/react-data-grid/license-install/) to start using our advanced features, or [Get Started with AG Grid Community](/react-data-grid/getting-started/) to explore the core functionality of the grid.

* [Community vs. Enterprise](#top)
* [Overview](#overview)
* [Community Features](#community-features)
* [Enterprise Features](#enterprise-features)
* [Enterprise Bundle](#enterprise-bundle)
* [Test AG Grid Enterprise Features](#test-ag-grid-enterprise-features)
* [Request an Enterprise Bundle Trial Licence](#request-an-enterprise-bundle-trial-licence)
