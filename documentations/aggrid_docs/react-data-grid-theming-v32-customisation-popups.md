...
This example combines all of the above techniques to style the column menus. Click on the menu icon in a column header, or right click on the grid to show a floating menu:
...
* [Legacy Themes: Customising Menus & Popups](#top)
