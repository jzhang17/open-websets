...
# React Data GridUpgrading to AG Grid 33.2
...
AG Grid 33.2 adds major new features - [Find](/react-data-grid/find/), [Tree Data Self-Referencing Records](/react-data-grid/tree-data-self-referential/), [Status Bar Value Formatting](/react-data-grid/status-bar/#value-formatting), [Row Spanning Pagination Support](/react-data-grid/row-spanning/) as described in the [release post](https://blog.ag-grid.com/whats-new-in-ag-grid-33-2/).

These improvements involve no breaking changes or deprecations, as listed below.

## Documentation [Copy Link](#documentation)

See [AG Grid 33.2 Documentation](https://www.ag-grid.com/archive/33.2.4/documentation).
...
See the full list of changes in the [AG Grid 33.2 changelog](https://www.ag-grid.com/changelog/?fixVersion=33.2.0).

* [Upgrading to AG Grid 33.2](#top)
* [What's New](#whats-new)
