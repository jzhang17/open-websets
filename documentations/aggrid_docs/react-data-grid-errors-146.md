...
# React Data GridAG Grid React Error #146
...
```
Unable to instantiate component 'undefined' as its module hasn't been loaded. Add 'ValidationModule' to see which module is required.
```
...
* [Modules](/react-data-grid/modules/)

* [AG Grid React Error #146](#top)
