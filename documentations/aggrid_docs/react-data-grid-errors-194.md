...
# React Data GridAG Grid React Error #194
...
calling gridApi.undefined() is only possible when using rowModelType=`clientSide`.
...
* [Row Models](/react-data-grid/row-models/)

* [AG Grid React Error #194](#top)
