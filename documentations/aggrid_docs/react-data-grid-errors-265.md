...
# React Data GridAG Grid React Error #265
...
Unable to infer chart data type for column 'undefined' if first data entry is null. Please specify "chartDataType", or a "cellDataType" in the column definition. For more information, see https://www.ag-grid.com/javascript-data-grid/integrated-charts-range-chart#coldefchartdatatype .
...
* [Integrated Charts - Chart Data Type](/react-data-grid/integrated-charts-range-chart/#coldefchartdatatype)

* [AG Grid React Error #265](#top)
