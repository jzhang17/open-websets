...
# React Data GridClient-Side Data - High Frequency Updates
...
##  Async Transactions [Copy Link](#async-transactions) 
...
| applyTransactionAsync[Copy Link](#reference-data-applyTransactionAsync)FunctionSame as applyTransaction except executes asynchronously for efficiency.[ClientSideRowModelApiModule](/react-data-grid/modules/) |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

The following example demonstrates updating data using normal transactions and async transactions:

* **Normal Update**: Calls `applyTransaction()` 500 times with each call updating a single row.
* **Async Update**: Calls `applyTransactionAsync()` 500 times with each call updating a single row.
...
##  Async Transactions Applied Event [Copy Link](#async-transactions-applied-event) 
...
##  Flush Async Transactions [Copy Link](#flush-async-transactions) 
...
* [Client-Side Data - High Frequency Updates](#top)
* [Async Transactions](#async-transactions)
* [Async Transactions Applied Event](#async-transactions-applied-event)
* [Flush Async Transactions](#flush-async-transactions)
