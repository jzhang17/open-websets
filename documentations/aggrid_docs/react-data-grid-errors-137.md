...
# React Data GridAG Grid React Error #137
...
```
Unable to update chart as a 'undefined' update type is not permitted on a undefined.
```
...
* [User Created Charts](/react-data-grid/integrated-charts-user-created/)

* [AG Grid React Error #137](#top)
