...
# React Data GridNumber Cell Editor
...
##  Enabling Number Cell Editor [Copy Link](#enabling-number-cell-editor) 
...
###  Step and Precision [Copy Link](#step-and-precision) 
...
###  Prevent Stepping [Copy Link](#prevent-stepping) 
...
| min[Copy Link](#reference-INumberCellEditorParams-min)number Min allowed value.                                                                                                                                                                                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| max[Copy Link](#reference-INumberCellEditorParams-max)number Max allowed value.                                                                                                                                                                                                                                                                                           |
| precision[Copy Link](#reference-INumberCellEditorParams-precision)number Number of digits allowed after the decimal point.                                                                                                                                                                                                                                                |
| step[Copy Link](#reference-INumberCellEditorParams-step)number Size of the value change when stepping up/down, starting from min or the initial value if provided. Step is also the difference between valid values. If the user-provided value isn't a multiple of the step value from the starting value, it will be considered invalid. Defaults to any value allowed. |
| showStepperButtons[Copy Link](#reference-INumberCellEditorParams-showStepperButtons)booleandefault: false Display stepper buttons in editor. Note: Does not work when preventStepping is true.                                                                                                                                                                            |
| preventStepping[Copy Link](#reference-INumberCellEditorParams-preventStepping)booleandefault: false Set to true to prevent key up/down from stepping the field's value.                                                                                                                                                                                                   |

##  Next Up [Copy Link](#next-up) 

Continue to the next section: [Date Cell Editor](/react-data-grid/provided-cell-editors-date/).

* [Number Cell Editor](#top)
* [Enabling Number Cell Editor](#enabling-number-cell-editor)
* [Customisation](#customisation)
* [Step and Precision](#step-and-precision)
* [Prevent Stepping](#prevent-stepping)
