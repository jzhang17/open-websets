...
# React Data GridLarge Text Cell Editor
...
##  Enabling Large Text Cell Editor [Copy Link](#enabling-large-text-cell-editor) 
...
###  Editor Size [Copy Link](#editor-size) 
...
| maxLength[Copy Link](#reference-ILargeTextEditorParams-maxLength)numberdefault: 200 Max number of characters to allow. |
| ---------------------------------------------------------------------------------------------------------------------- |
| rows[Copy Link](#reference-ILargeTextEditorParams-rows)numberdefault: 10 Number of character rows to display.          |
| cols[Copy Link](#reference-ILargeTextEditorParams-cols)numberdefault: 60 Number of character columns to display.       |

Continue to the next section: [Select Cell Editor](/react-data-grid/provided-cell-editors-select/).

* [Large Text Cell Editor](#top)
* [Enabling Large Text Cell Editor](#enabling-large-text-cell-editor)
