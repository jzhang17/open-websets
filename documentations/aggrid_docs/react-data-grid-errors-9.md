...
# React Data GridAG Grid React Error #9
...
```
No value for undefined. This usually means that the grid has been initialised before styles have been loaded. The default value of undefined will be used and updated when styles load.
```

To show this error text in the dev console, import the `ValidationModule`.

* [AG Grid React Error #9](#top)
