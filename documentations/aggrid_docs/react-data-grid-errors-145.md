...
# React Data GridAG Grid React Error #145
...
As of v32, only one charts customize panel group can be expanded at a time. 'undefined' will not be expanded.
...
* [Chart Tool Panels](/react-data-grid/integrated-charts-chart-tool-panels/)

* [AG Grid React Error #145](#top)
