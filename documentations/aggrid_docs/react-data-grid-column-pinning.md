...
## Pinning via Column Dragging [Copy Link](#pinning-via-column-dragging)
...
[](/_astro/pinning-by-moving.CF95tIue.mp4)

## Resizing Pinned Sections [Copy Link](#resizing-pinned-sections)
...
## Lock Pinned [Copy Link](#lock-pinned)
...
* [Column Pinning](#top)
* [Pinning via Column Dragging](#pinning-via-column-dragging)
* [Resizing Pinned Sections](#resizing-pinned-sections)
* [Lock Pinned](#lock-pinned)
