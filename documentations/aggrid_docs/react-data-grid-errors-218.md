...
# React Data GridAG Grid React Error #218
...
```
undefined must be a number, the value you provided is not a valid number. Using the default of undefinedpx.
```

To show this error text in the dev console, import the `ValidationModule`.

* [AG Grid React Error #218](#top)
