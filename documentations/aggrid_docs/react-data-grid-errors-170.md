...
# React Data GridAG Grid React Error #170
...
```
invalid cellRendererParams.refreshStrategy = undefined supplied, defaulting to refreshStrategy = 'rows'.
```
...
* [Master Detail - Refresh](/react-data-grid/master-detail-refresh/)

* [AG Grid React Error #170](#top)
