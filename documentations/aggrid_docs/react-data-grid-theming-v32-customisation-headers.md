...
## Header Column Separators and Resize Handles [Copy Link](#header-column-separators-and-resize-handles)
...
## Full List of Header Variables [Copy Link](#full-list-of-header-variables)
...
* [Legacy Themes: Customising the Header](#top)
* [Header Column Separators and Resize Handles](#header-column-separators-and-resize-handles)
* [Style Header on Filter](#style-header-on-filter)
* [Styling the First and Last Columns](#styling-the-first-and-last-columns)
* [Full List of Header Variables](#full-list-of-header-variables)
