...
# React Data GridAG Grid React Error #188
...
getRowId callback must be provided for Server Side Row Model selection to work correctly.
...
* [Row IDs](/react-data-grid/row-ids/#row-ids)  \- Configuration requirements for row IDs.
* [SSRM Row Selection](/react-data-grid/server-side-model-selection/)

* [AG Grid React Error #188](#top)
