...
1. Choose a different [Color Scheme](/react-data-grid/theming-colors/#color-schemes) if required.
2. Use [Theme Parameters](/react-data-grid/theming-parameters/) to customise borders, compactness, fonts and more.
3. Use [Theme Parts](/react-data-grid/theming-parts/) mix and match elements from different themes, for example the icons from Quartz with the text inputs from Material.
4. [Write your own CSS](/react-data-grid/theming-css/) for unlimited control over grid appearance.

* [Built-in themes](#top)
* [Built-in Themes](#built-in-themes)
* [Customising Built-in Themes](#customising-built-in-themes)
