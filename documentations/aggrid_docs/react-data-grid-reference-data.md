...
## Using Value Handlers [Copy Link](#using-value-handlers)
...
### Example: Value Handlers [Copy Link](#example-value-handlers)
...
## Using the 'refData' Property [Copy Link](#using-the-refdata-property)
...
|  |
| --- |
| refData[Copy Link](#reference-columns-refData)  { [key: string]: string }  Provided a reference data map to be used to map column values to their respective value from the map. |
...
### Example: 'refData' Property [Copy Link](#example-refdata-property)
...
* [Reference Data](#top)
* [Using Value Handlers](#using-value-handlers)
* [Example: Value Handlers](#example-value-handlers)
* [Using the 'refData' Property](#using-the-refdata-property)
* [Example: 'refData' Property](#example-refdata-property)
