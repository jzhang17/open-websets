...
# React Data GridAG Grid React Error #260
...
## AG Grid Modules [Copy Link](#ag-grid-modules)

AG Grid features are split into [Modules](/react-data-grid/modules/) to help reduce application bundle size by enabling developers to cherry pick the features they require. This error occurs when a feature is used without the feature's module being registered first.

For a comprehensive guide on AG Grid Modules please see [Modules](/react-data-grid/modules/).

### Minimized Bundle Size [Copy Link](#minimized-bundle-size)
...
We recommend using the [Module Selector Tool](/react-data-grid/modules/#selecting-modules) to identify all the modules required for your application's features. The tool will generate the module registration code which can be copied into your application.

### All Feature Bundles [Copy Link](#all-feature-bundles)

If you are not concerned about bundle size, you can import all community / enterprise features via the [bundles](/react-data-grid/modules/#bundles) `AllCommunityModule` / `AllEnterpriseModule`.
...
* [AG Grid React Error #260](#top)
* [Full Error Text](#reference-full-error-text)
* [AG Grid Modules](#ag-grid-modules)
* [Minimized Bundle Size](#minimized-bundle-size)
* [All Feature Bundles](#all-feature-bundles)
