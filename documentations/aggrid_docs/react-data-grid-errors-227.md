...
# React Data GridAG Grid React Error #227
...
```
menu item icon must be DOM node or string
```
...
* [Menu Item Component](/react-data-grid/component-menu-item/)

* [AG Grid React Error #227](#top)
