...
##  Touch Gestures for AG Grid Community [Copy Link](#touch-gestures-for-ag-grid-community) 
...
##  Touch Gestures for AG Grid Enterprise [Copy Link](#touch-gestures-for-ag-grid-enterprise) 
...
##  Enabling Double Clicking on Mobile Devices [Copy Link](#enabling-double-clicking-on-mobile-devices) 
...
##  Column Menu Touch Configuration [Copy Link](#column-menu-touch-configuration) 
...
###  Legacy Tabbed Column Menu [Copy Link](#legacy-tabbed-column-menu) 

If the [Legacy Tabbed Column Menu](/react-data-grid/column-menu/#legacy-tabbed-column-menu) is enabled, the column menu icon is hidden by default and only appears on mouseover. On touch devices, this mouseover behaviour is not possible, so it is displayed via tap and hold on the column header.

###  Suppress Menu Hide [Copy Link](#suppress-menu-hide) 
...
##  Custom Header Components [Copy Link](#custom-header-components) 
...
* [Touch](#top)
* [Touch Gestures for AG Grid Community](#touch-gestures-for-ag-grid-community)
* [Touch Gestures for AG Grid Enterprise](#touch-gestures-for-ag-grid-enterprise)
* [Enabling Double Clicking on Mobile Devices](#enabling-double-clicking-on-mobile-devices)
* [Column Menu Touch Configuration](#column-menu-touch-configuration)
* [Legacy Tabbed Column Menu](#legacy-tabbed-column-menu)
* [Suppress Menu Hide](#suppress-menu-hide)
* [Custom Header Components](#custom-header-components)
