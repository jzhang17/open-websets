...
# React Data GridAG Grid React Error #168
...
```
detailCellRendererParams.template should be function or string
```
...
* [Master Detail](/react-data-grid/master-detail-grids/)
* [Master Detail - Custom Detail](/react-data-grid/master-detail-custom-detail/)

* [AG Grid React Error #168](#top)
