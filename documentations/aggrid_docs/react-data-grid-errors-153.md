...
# React Data GridAG Grid React Error #153
...
```
unexpected chartDataType value 'undefined' supplied, instead use 'category', 'series' or 'excluded'
```
...
* [Chart Types](/react-data-grid/integrated-charts-chart-types/)

* [AG Grid React Error #153](#top)
