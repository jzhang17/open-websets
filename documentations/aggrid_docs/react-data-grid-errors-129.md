...
# React Data GridAG Grid React Error #129
...
undefined is only available if using 'clientSide' or 'serverSide' rowModelType, you are using undefined.

To show this error text in the dev console, import the `ValidationModule`.

* [AG Grid React Error #129](#top)
