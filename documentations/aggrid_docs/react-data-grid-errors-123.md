...
# React Data GridAG Grid React Error #123
...
```
Advanced Filter is only supported with the Client-Side Row Model or Server-Side Row Model.
```
...
* [Advanced Filter](/react-data-grid/filter-advanced/)

* [AG Grid React Error #123](#top)
