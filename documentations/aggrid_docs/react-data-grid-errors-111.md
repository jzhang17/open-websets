...
# React Data GridAG Grid React Error #111
...
```
Invalid selection state. When `groupSelects` is enabled, the state must conform to `IServerSideGroupSelectionState`.
```
