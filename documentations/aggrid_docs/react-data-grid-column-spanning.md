...
# React Data GridColumn Spanning
...
##  Configuring Column Spanning [Copy Link](#configuring-column-spanning) 
...
| colSpan[Copy Link](#reference-spanning-colSpan)FunctionBy default, each cell will take up the width of one column. You can change this behaviour to allow cells to span multiple columns. |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

##  Column Spanning Simple Example [Copy Link](#column-spanning-simple-example) 
...
##  Column Spanning Complex Example [Copy Link](#column-spanning-complex-example) 
...
##  Column Spanning Constraints [Copy Link](#column-spanning-constraints) 
...
* [Cell Selection](/react-data-grid/cell-selection/) will not work correctly when spanning cells. This is because it is not possible to cover all scenarios, as a range is no longer a perfect rectangle.

* [Column Spanning](#top)
* [Configuring Column Spanning](#configuring-column-spanning)
* [Column Spanning Simple Example](#column-spanning-simple-example)
* [Column Spanning Complex Example](#column-spanning-complex-example)
* [Column Spanning Constraints](#column-spanning-constraints)
