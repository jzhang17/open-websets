...
The above example uses `theme.withoutPart("checkboxStyle")` to disable the default checkbox styles and adds its own checkbox styles in the application style sheet. If you want to distribute the checkbox style as a library, you can create your own `checkboxStyle` part, see [Distributing Shared Themes & Parts](/react-data-grid/theming-distribution/#creating-your-own-parts).

* [Theme Parts](#top)
* [Configuring Theme Parts](#configuring-theme-parts)
* [Parts Reference](#parts-reference)
* [Removing a Part](#removing-a-part)
