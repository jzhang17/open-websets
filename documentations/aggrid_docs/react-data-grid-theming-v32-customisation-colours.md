...
##  Key colour variables [Copy Link](#key-colour-variables) 

Some of the most important colour variables are listed below. For the full list check the full [CSS variables reference](/react-data-grid/theming-v32-customisation-variables/) \- every colour variable ends with `-color`.
...
##  Colour blending [Copy Link](#colour-blending) 
...
If you're on a theme other than Quartz, you can achieve this effect yourself using the CSS [color-mix()](https://developer.mozilla.org/en-US/docs/Web/CSS/color%5Fvalue/color-mix) function. Here is how you would set the range selection background to a 20% opaque red when using the Alpine theme:
...
* [Legacy Themes: Customising Colours & Fonts](#top)
* [Example](#example)
* [Key colour variables](#key-colour-variables)
* [Colour blending](#colour-blending)
