...
# React Data GridTheming: Customising Fonts
...
| `{ googleFont: 'IBM Plex Sans' }` | A font available from Google Fonts. You must load the font or ask the grid to load it for you, see [Loading Google Fonts](#loading-google-fonts) below. |
...
## Loading Google Fonts [Copy Link](#loading-google-fonts)
...
* [Theming: Customising Fonts](#top)
* [Font Family Parameters](#font-family-parameters)
* [Extended Syntax for Font Family Parameters](#extended-syntax-for-font-family-parameters)
