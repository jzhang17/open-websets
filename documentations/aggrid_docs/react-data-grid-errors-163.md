...
# React Data GridAG Grid React Error #163
...
```
Excel table export does not work with undefined. The exported Excel file will not contain any Excel tables.
 Please turn off undefined to enable Excel table exports.
```
...
* [Excel Export](/react-data-grid/excel-export/)

* [AG Grid React Error #163](#top)
