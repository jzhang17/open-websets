...
[![React Column Filters thumbnail](https://img.youtube.com/vi/pebXUHUdlos/0.jpg)](https://www.youtube.com/watch?v=pebXUHUdlos)

Column Filters are accessed in the grid UI either through the [Column Menu](/react-data-grid/column-menu/) or the [Tool Panel](/react-data-grid/tool-panel/).

[](/_astro/column-filters.8Zrvp1AA.mp4)

## Column Filter Types [Copy Link](#column-filter-types)

You can use the Provided Filters that come with the grid, or you can build your own [Filter Components](/react-data-grid/component-filter/) if you want to customise the filter experience to your application.

There are four main Provided Filters, plus the Multi Filter. These are as follows:

* [Text Filter](/react-data-grid/filter-text/) - A filter for string comparisons.
* [Number Filter](/react-data-grid/filter-number/) - A filter for number comparisons.
* [Date Filter](/react-data-grid/filter-date/) - A filter for date comparisons.
* [Set Filter](/react-data-grid/filter-set/) (e) - A filter influenced by how filters work in Microsoft Excel. This is an AG Grid Enterprise feature.
* [Multi Filter](/react-data-grid/filter-multi/) (e) - Allows for two filters to be used together (either one of the above Provided Filters or a Custom Filter Component). This is an AG Grid Enterprise feature.
...
Column Filters work independently of [Quick Filter](/react-data-grid/filter-quick/) and [External Filter](/react-data-grid/filter-external/). If Quick Filter and / or an external filter are applied along with a Column Filter, each filter type is considered and the row will only show if it passes all three types.
...
Continue to the next section to learn about [Text Filters](/react-data-grid/filter-text/).

* [Column Filters](#top)
* [Column Filter Types](#column-filter-types)
* [Example: Provided Filters](#example-provided-filters)
* [Relation to Quick Filter and External Filter](#relation-to-quick-filter-and-external-filter)
* [Next Up](#next-up)
