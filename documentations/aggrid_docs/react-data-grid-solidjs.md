...
# React Data GridSolidJS

![react logo](/_astro/react.CtDRhtxt.svg)React

The AG Grid SolidJS wrapper is maintained by the community. See the [GitHub repository](https://github.com/solidjs-community/solid-ag-grid) for more information.
