...
# React Data GridAG Grid React Error #7
...
```
Pivoting is not supported with aligned grids as it may produce different columns in each grid.
```
...
* [Aligned Grids](/react-data-grid/aligned-grids/)

* [AG Grid React Error #7](#top)
