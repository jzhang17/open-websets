...
# React Data GridAG Grid React Error #187
...
```
Duplicate node id undefined. Row IDs are provided via the getRowId() callback. Please modify the getRowId() callback code to provide unique row id values.
first instance
second instance
```
