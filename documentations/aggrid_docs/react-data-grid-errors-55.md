...
# React Data GridAG Grid React Error #55
...
addRowDropZone - A container target needs to be provided
...
* [Row Dragging to an External Drop Zone](/react-data-grid/row-dragging-to-external-dropzone/)

* [AG Grid React Error #55](#top)
