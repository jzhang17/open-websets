...
# React Data GridAG Grid React Error #70
...
```
Grid option quickFilterText only supports string inputs, received: undefined
```
...
* [Quick Filter](/react-data-grid/filter-quick/)

* [AG Grid React Error #70](#top)
