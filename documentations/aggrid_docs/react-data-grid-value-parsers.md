...
| valueParser[Copy Link](#reference-editing-valueParser)string \| ValueParserFuncFunction or [expression](/react-data-grid/cell-expressions/#column-definition-expressions). Parses the value for saving. |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
##  Use Value Parser for Import [Copy Link](#use-value-parser-for-import) 
...
Using a value parser for import is normally used in conjunction with [Using a Value Formatter for Export](/react-data-grid/value-formatters/#formatting-for-export), where a [Value Formatter](/react-data-grid/value-formatters/) is defined that does the reverse of the value parser.
...
* [Use Value Parser for Import](#use-value-parser-for-import)
