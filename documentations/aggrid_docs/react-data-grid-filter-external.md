...
This form of filtering is only compatible with the Client-Side Row Model, see [Row Models](/react-data-grid/row-models/) for more details.

## Implementing External Filtering [Copy Link](#implementing-external-filtering)
...
|  |
| --- |
| isExternalFilterPresent[Copy Link](#reference-filter-isExternalFilterPresent)  Function  Grid calls this method to know if an external filter is present.  [ExternalFilterModule](/react-data-grid/modules/) |
| doesExternalFilterPass[Copy Link](#reference-filter-doesExternalFilterPass)  Function  Should return `true` if external filter passes, otherwise `false`.  [ExternalFilterModule](/react-data-grid/modules/) |

### isExternalFilterPresent [Copy Link](#isexternalfilterpresent)
...
### doesExternalFilterPass [Copy Link](#doesexternalfilterpass)
...
Continue to the next section to learn about [Quick Filters](/react-data-grid/filter-quick/).

* [External Filter](#top)
* [Implementing External Filtering](#implementing-external-filtering)
