...
### Using your app's existing CSS Variables [Copy Link](#using-your-apps-existing-css-variables)

If your app already defines a colour scheme using CSS variables and you want to use those existing variable names rather than the `--ag-{variable-name}` provided by the grid, you can do this by passing a CSS `var()` value to a CSS variable. For example, if your application defines a CSS variable `--appMainTextColor` and you want to set the `--ag-foreground-color` variable at runtime using this variable, you can do so like this:
...
### Variable Cascading [Copy Link](#variable-cascading)
...
* [Legacy Themes: Using CSS](#top)
* [Setting CSS Variables](#setting-css-variables)
* [Using your app's existing CSS Variables](#using-your-apps-existing-css-variables)
* [Variable Cascading](#variable-cascading)
* [Customising Themes using CSS Rules](#customising-themes-using-css-rules)
* [Referencing Variable Values in CSS Rules](#referencing-variable-values-in-css-rules)
