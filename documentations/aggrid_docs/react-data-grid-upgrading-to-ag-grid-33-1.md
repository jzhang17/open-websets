...
# React Data GridUpgrading to AG Grid 33.1
...
AG Grid 33.1 adds major new features - [Row Numbers](/react-data-grid/row-numbers/), [Row Spanning](/react-data-grid/row-spanning/), [Master/Detail Selection](/react-data-grid/master-detail-grids/#row-selection), [Tree Data Nested Records](/react-data-grid/tree-data-nesting/) as described in the [release post](https://blog.ag-grid.com/whats-new-in-ag-grid-33-1/).
...
See the full list of changes in the [AG Grid 33.1 changelog](https://www.ag-grid.com/changelog/?fixVersion=33.1.0).

* [Upgrading to AG Grid 33.1](#top)
* [What's New](#whats-new)
