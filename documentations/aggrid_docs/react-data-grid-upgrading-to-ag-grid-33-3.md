...
# React Data GridUpgrading to AG Grid 33.3
...
AG Grid 33.3 adds important new features - [Row Pinning](/react-data-grid/row-pinning/), [Row Height Resizing](/react-data-grid/row-numbers/#row-resizing), [Grand Total Row Pinning](/react-data-grid/row-pinning/#pinning-the-grand-total-row), Scroll Column Into View as described in the [release post](https://blog.ag-grid.com/whats-new-in-ag-grid-33-3/).
...
###  AgGridReactProps interface [Copy Link](#aggridreactprops-interface) 

* `setGridApi` \- deprecated without replacement as no longer used.
* `children` \- deprecated without replacement as no longer used.
* `maxComponentCreationTimeMs` \- deprecated without replacement as no longer used.

## Changes List [Copy Link](#changes-list)

See the full list of changes in the [AG Grid 33.3 changelog](https://www.ag-grid.com/changelog/?fixVersion=33.3.0).

* [Upgrading to AG Grid 33.3](#top)
* [What's New](#whats-new)
* [Breaking Changes](#breaking-changes)
* [Behaviour Changes](#behaviour-changes)
* [Removal of Deprecated APIs](#removal-of-deprecated-apis)
* [Deprecations](#deprecations)
* [AgGridReactProps interface](#aggridreactprops-interface)
