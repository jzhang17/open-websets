...
## Enabling Row Selection [Copy Link](#enabling-row-selection)
...
* [Single Row Selection](/react-data-grid/row-selection-single-row/)
* [Multi-Row Selection](/react-data-grid/row-selection-multi-row/)
...
Continue to the next section to learn about [Single Row Selection](/react-data-grid/row-selection-single-row/).

* [Row Selection](#top)
* [Enabling Row Selection](#enabling-row-selection)
