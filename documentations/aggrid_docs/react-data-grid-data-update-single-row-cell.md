...
# React Data GridClient-Side Data - Single Row / Cell Updates
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| setData[Copy Link](#reference-data-setData)FunctionReplaces the data on the rowNode. When this method is called, the grid will refresh the entire rendered row if it is displayed.                                                                                                                                                                                                                                                                                              |
...
##  View Refresh [Copy Link](#view-refresh) 
...
The main difference between `setData` and `updateData` is that `setData` will always refresh every cell, whereas `updateData` will only refresh cells whose values have changed. Additionally, `setData` will not cause changed cells to flash when `ColDef.enableCellChangeFlash = true`.

##  Sort / Filter / Group Refresh [Copy Link](#sort--filter--group-refresh) 
...
If you want the grid to automatically update sorting, filter or grouping then you should consider using [Transaction Updates](/react-data-grid/data-update-transactions/).

##  Updating Rows / Cells Example [Copy Link](#updating-rows--cells-example) 
...
* [Client-Side Data - Single Row / Cell Updates](#top)
* [View Refresh](#view-refresh)
* [Sort / Filter / Group Refresh](#sort--filter--group-refresh)
* [Updating Rows / Cells Example](#updating-rows--cells-example)
