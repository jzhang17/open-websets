...
# React Data GridUpgrading Styles to v28+
...
* Much easier to perform simple modifications to themes such as [changing the compactness](/react-data-grid/theming-v32-customisation-compactness/) - projects that previously had to integrate a Sass compiler in order to make simple changes to our provided themes can now do so with a few lines of CSS.
...
See the instructions [for CSS users](/react-data-grid/theming-v32-upgrading-to-v28-css/) and the instructions [for Sass users](/react-data-grid/theming-v32-upgrading-to-v28-sass/).
