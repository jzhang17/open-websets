...
Reranking documents can greatly improve any RAG application and document retrieval system.](/docs/integrations/document_compressors/cohere_rerank)

[## 📄️ IBM watsonx.ai

Overview](/docs/integrations/document_compressors/ibm)

[## 📄️ Mixedbread AI reranking

Overview](/docs/integrations/document_compressors/mixedbread_ai)

[Previous

OpenAI functions metadata tagger](/docs/integrations/document_transformers/openai_metadata_tagger)[Next
